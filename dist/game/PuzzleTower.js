...
var PuzzleTower = function () {
  ...
  * */
	...
	_createClass(PuzzleTower, [{
		...
		key: 'closeAndSetGameState',
		value: function closeAndSetGameState(newMode) {
		...
		key: 'setScoreCardText',
		value: function setScoreCardText() {
